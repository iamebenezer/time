! function(e, t) {
    ...
    const V = {
            ...
            getDataAttributes(i) {
                ...
                return Object.keys(i.dataset).filter(e => e.startsWith("bs")).forEach(e => {
                    let t = e.replace(/^bs/, "");
                    t = t.charAt(0).toLowerCase() + t.slice(1, t.length), s[t] = U(i.dataset[e])
                }), s
            },
    ...
    function Pe(e) {
        var t, i, s, n = e.popper,
            ...
            h = e.adaptive,
            d = e.roundOffsets,
            u = !0 === d ? (t = a.x, i = a.y, s = window.devicePixelRatio || 1, {
                x: De(De(t * s) / s) || 0,
                y: De(De(i * s) / s) || 0
            }) : "function" == typeof d ? d(a) : a,
            f = u.x,
            p = void 0 === f ? 0 : f,
            m = u.y,
            e = void 0 === m ? 0 : m,
            t = a.hasOwnProperty("x"),
            i = a.hasOwnProperty("y"),
            s = ae,
            d = ne,
            f = window;
        h && (u = "clientHeight", m = "clientWidth", (a = Ce(n)) === fe(n) && "static" !== Ee(a = Ae(n)).position && (u = "scrollHeight", m = "scrollWidth"), r === ne && (d = oe, e -= a[u] - o.height, e *= c ? 1 : -1), r === ae && (s = re, p -= a[m] - o.width, p *= c ? 1 : -1));
        var h = Object.assign({
            position: l
        }, h && Me);
        return c ? Object.assign({}, h, ((c = {})[d] = i ? "0" : "", c[s] = t ? "0" : "", c.transform = (f.devicePixelRatio || 1) < 2 ? "translate(" + p + "px, " + e + "px)" : "translate3d(" + p + "px, " + e + "px, 0)", c)) : Object.assign({}, h, ((h = {})[d] = i ? e + "px" : "", h[s] = t ? p + "px" : "", h.transform = "", h))
    }
    var He = {
            name: "computeStyles",
            enabled: !0,
    ...
    function Fe(e) {
        return ve(Ae(e)).left + Ue(e).scrollLeft
    }
                            ...
                            if (at(t, e)) {
                                l.rects = {
                                    reference: function(e, t, i) {
                                        ...
                                        } : Ue(i)), me(t) ? ((e = ve(t)).x += t.clientLeft, e.y += t.clientTop) : s && (e.x = Fe(s))), {
    ...
    class Xt extends $t {
        ...
        _cleanTipClass() {
            const t = this.getTipElement(),
                e = t.getAttribute("class").match(Ut);
            null !== e && 0 < e.length && e.map(e => e.trim()).forEach(e => t.classList.remove(e))
        }
        static jQueryInterface(t) {
            return this.each(function() {
