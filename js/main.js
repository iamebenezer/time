    ...
    var banu = {
        ...
        slickActivation: function() {
            $(".slick-activation-01").slick({
                ...
                cssEase: "linear",
                adaptiveHeight: true,
                prevArrow: '<button class="slide-arrow prev-arrow"><i class="ri-arrow-left-line"></i></button>',
                nextArrow: '<button class="slide-arrow next-arrow"><i class="ri-arrow-right-line"></i></button>',
                responsive: [{
                        breakpoint: 1919,
                        settings: {
                            slidesToShow: 4,
