...
const connetw = document.getElementById("connetw");
const accountAvater = document.getElementById("accountAvater");
    ...
    if (typeof window.ethereum !== "undefined") {
        ...
        ethereum
            ...
            .then((accounts) => {
                ...
                connetw.classList.add("d-none");
                accountAvater.classList.add("d-block");


                accountid.innerHTML = `${account}`;
...
var myModal = new bootstrap.Modal(document.getElementById('connetwallet'), {
    keyboard: false
})
